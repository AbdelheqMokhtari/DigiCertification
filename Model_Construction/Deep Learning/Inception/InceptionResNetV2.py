...
save_history_json(history, 'history/CNCC/InceptionResNetV2/InceptionResNetV2_epochs50_unfreeze10_history.json')

# Evaluate the model
model.evaluate(test_data)

# Save the model
model.save('Model/CNCC/InceptionResNetV2/InceptionResNetV2_epochs50_unfreeze10_model.h5')

# Save class names as attributes of the HDF5 file
with h5py.File('Model/CNCC/InceptionResNetV2/InceptionResNetV2_epochs50_unfreeze10_model.h5', 'a') as file:
