...
save_history_json(history, 'history/CNCC/VGG19/VGG19_epochs50_freeze_history.json')

# Evaluate the model
model.evaluate(test_data)

# Save the model
model.save('Model/CNCC/VGG19/VGG19_epochs50_freeze_model.h5')

# Save class names as attributes of the HDF5 file
with h5py.File('Model/CNCC/VGG19/VGG19_epochs50_freeze_model.h5', 'a') as file:
