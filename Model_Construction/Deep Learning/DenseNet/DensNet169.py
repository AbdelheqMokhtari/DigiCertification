...
save_history_json(history, 'history/CNCC/DenseNet169/DenseNet169_epochs50_unfreeze20_history.json')

# Evaluate the model
model.evaluate(test_data)

# Save the model
model.save('Model/CNCC/DenseNet169/DenseNet169_epochs50_unfreeze15_model.h5')

# Save class names as attributes of the HDF5 file
with h5py.File('Model/CNCC/DenseNet169/DenseNet169_epochs50_unfreeze15_model.h5', 'a') as file:
