...
checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    'callbacks/best_weights_DenseNet121.h5',
...
save_history_json(history, 'history/CCLS/DenseNet121/DenseNet121_epochs100_unfreeze5_best_weight_history.json')

model.load_weights('callbacks/best_weights_DenseNet121.h5')

# Evaluate the model
model.evaluate(test_data)

# Save the model
model.save('Model/CCLS/DenseNet121/DenseNet121_epochs100_unfreeze5_best_weight_model.h5')

# Save class names as attributes of the HDF5 file
with h5py.File('Model/CCLS/DenseNet121/DenseNet121_epochs100_unfreeze5_best_weight_model.h5', 'a') as file:
