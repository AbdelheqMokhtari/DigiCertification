...
def observation_(poid_specifique, humidite,grains_nuisible,ergot, grains_casse, grain_boute, ble_tendre_dans_ble_dur):
    ...
    if 1 <= total_premier_category <= 3:
        ...
        obsrvation_total_premier_category = "bonification"
    ...
    if 1 <= total_dexieum_category <= 10:
        obsrvation_total_dexieum_category = "sans bonification ni rèfaction"
    elif 10 < total_dexieum_category <= 20:
        obsrvation_total_dexieum_category = "rèfaction"
...
bon_ble_tendre, bon_metadines_category, bon_boute = bonification (poid_specifique,  matiers_inertes , debris_vegetaux, grains_nuisible , ergot , grains_sons_valours, grains_casse,
                 grains_maigres, grains_mouchetes, grain_boute, grain_punaise,
                 grains_pique, autres_cereales ,ble_tendre_dans_ble_dur)
